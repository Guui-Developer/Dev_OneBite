...
export default function ContentModal({
  ...
  const modalContent = (
    ...
    >
      <div
        ref={containerRef}
        className={`h-screen snap-start snap-always flex items-center justify-center px-4 pt-[60px] relative overflow-y-auto transition-transform duration-300 max-w-md mx-auto ${
          isDragging ? '' : 'ease-out'
        }`}
        style={{
